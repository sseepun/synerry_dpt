    ...
    <div class="popup-container simple active" data-popup="subscribe">
        <div class="wrapper">
            <div class="popup-box border bcolor-white bg-white px-2 py-2">
                ...
                <div class="position-relative d-flex ai-center jc-end mt-2">
                    <div class="form-check sm mr-4">
                        ...
                        <label class="pt-1" for="show-toggle">ไม่ต้องแสดงอีก</label>
                    </div>
                    <a class="btn btn-action btn-sm btn-color-09 btn-popup-toggle px-5" href="#" data-popup="subscribe">
                        <i class="far fa-times-circle mr-1"></i> ปิด
                    </a>
                </div>
            </div>
        </div>
