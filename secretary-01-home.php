...
<body class="loading">
    ...
    <section class="intro-03">
        <div class="wrapper">
            <div class="intro-cards">
                <div class="intro-card bradius-round bg-02" data-aos="fade-up" data-aos-delay="0">
                ...
                <div class="intro-card bradius-round bg-01" data-aos="fade-up" data-aos-delay="150">
    ...
    <section class="section-padding position-relative" style="z-index:1;">
        <div class="container">
            ...
            <div class="tab-container">
                <div class="tabs tabs-03" data-aos="fade-up" data-aos-delay="150">
                    <div class="btns">
    ...
    <section class="about-03 section-padding">
        ...
        <div class="container position-relative">
            <h6 class="h3 fw-600 color-white" data-aos="fade-up" data-aos-delay="0">
                ข่าวสารพลังงานจังหวัด
            </h6>
            <?php $categories = ['กิจกรรมพลังงานจังหวัด', 'จัดซื้อจัดจ้างพลังงานจังหวัด']; ?>
            <div class="tab-container">
                <div class="tabs tabs-04 mt-2 mb-2" data-aos="fade-up" data-aos-delay="150">
                    <?php foreach($categories as $j=>$k){?>
                        <a class="tab <?php if($j==0)echo 'active'; ?>" data-tab="<?= $j ?>" href="#">
                            <?= $k ?>
                        </a>
    ...
    <section class="about-05 section-padding pb-0 bg-01">
        <div class="container">
            ...
            <div class="gallery-grids">
                <div class="grid md-50 sm-100 about-grid" data-aos="fade-up" data-aos-delay="150">
                ...
                <div class="grid md-50 sm-100 position-relative" data-aos="fade-up" data-aos-delay="300">
    ...
    <section class="client-01 bg-mgray" data-aos="fade-up" data-aos-delay="0">
        <div class="container">
            <div class="slide-container">
                <div class="slides">
                    <?php for($i=0; $i<2; $i++){?>
