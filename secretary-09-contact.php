...
<body class="loading">
    ...
    <?php
        ...
        $breadcrumbBg = 'public/assets/app/images/bg/secretary-04.jpg';
                ...
                <div class="grid lg-50 sm-100 mt-0" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="gallery-grids mt-3">
                        <div class="grid lg-50 md-1-3">
                            <div class="contact-card-01 bradius-round">
                        ...
                        <div class="grid lg-50 md-1-3">
                            <div class="contact-card-01 bradius-round">
                                <div class="contact-tag">
                                    <img src="public/assets/app/images/icon/gas.png" alt="Contact Card Icon" />
                                </div>
                                <p class="fw-500">ศูนย์ข้อมูล LPG</p>	
                                <a class="p lg fw-600 color-01" href="#">
                                    02-239-9898
                                </a>
                            </div>
