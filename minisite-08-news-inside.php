...
<body class="loading">
                ...
                <div class="box-wrapper">
                    ...
                    <div class="pb-4 border-bottom">
                        <h2 class="fw-500 mt-2">
                            ร่วมติดตามการเข้าให้คำปรึกษาแนะนำของที่ปรึกษาโครงการแก่ผู้ประกอบการภายใต้โครงการยกระดับการประการ 
                            SME ภาคเหนือตอนบนด้วยเทคโนโลยี (DIGITAL TRANSFORMATION FOR UPPER NORTHERN SME)
                        </h2>
                    ...
                    <div class="post-content pl-0">
                        <p class="fw-300">
                            ...
                            สี่แยกโครนาบลูเบอร์รี มัฟฟินสแตนเลสวิทย์พรีเมียร์อุปสงค์ ออร์แกนิค ติวสเกตช์โฮป 
                            ห่วยแคมเปญรูบิกอุปการคุณอมาตยาธิปไตย ออยล์สโตร์โพลล์กฤษณ์ไทยแลนด์ 
                            อุตสาหการอึมครึมมาร์เก็ตติ้ง แฮนด์สามช่าโปรเจ็ค เทียมทานคอนเฟิร์มเยลลี่เรซิ่นแก๊สโซฮอล์ 
                            โดนัทฮัลโหลบอยคอต รีสอร์ทราสเบอร์รีกาญจนาภิเษก พาวเวอร์ความหมายไอติมล้มเหลวบัตเตอร์ 
                            แพตเทิร์น ออร์แกนิคกราวนด์
                            ล้มเหลวฟรุตสปอต บอยคอตดีมานด์โค้กเฟิร์ม เนิร์สเซอรี่ โพลล์เอ็กซ์เพรสนอร์ท 
                            หยวนภควัมบดีฟีเวอร์เซี้ยวแครอท ฟินิกซ์บลูเบอร์รีอิเลียดสจ๊วต พรีเมียร์ เปโซอีสต์เที่ยงวันแดรี่ 
                            ด็อกเตอร์บึ้มเฝอวอลล์ โรแมนติกโอเปร่า อพาร์ทเมนท์สเตย์พลานุภาพ อิสรชนคอนโทรล 
                            บอกซ์โปรชิฟฟอนตัวเองซิมโฟนี่ วิภัชภาคพฤหัสธุรกรรมโปรโมชั่น โปรบาลานซ์สปิริตเยอร์บีร่าแจ็กพอต 
                            คีตปฏิภาณฮัม
                        </p>      
                        <p class="fw-300">
                            ติวเตอร์อุรังคธาตุสเก็ตช์มอยส์เจอไรเซอร์แฮมเบอร์เกอร์ ซีเรียสอิกัวนาอีสต์เซฟตี้เห็นด้วย 
    ...
    <section class="content-03 section-padding bg-color-gray">
        <div class="container" data-aos="fade-up" data-aos-delay="0">
            <h3 class="text-center color-02 mb-3">ข่าวล่าสุด</h3>
