<div class="post-footer">
    ...
    <div class="block ai-start">
        <a class="btn btn-sm btn-round custom-btn-09 btn-toggle-02" href="#" data-toggle="embed-1">
            Embed <i class="fas fa-code color-white"></i>
        </a>
...
<div class="border-bottom position-relative">
    <div class="toggle-target-02" data-toggle="embed-1">
        <div class="ss-box ss-box-right pb-4">
            <textarea name="message" class="no-bradius" rows="2" data-copy="0">Temporary code test</textarea>
            <div class="btns mt-0">
                <a class="btn btn-sm custom-btn-09 no-bradius width-full" href="#" data-copy="0">
                    คัดลอกโค้ด
                </a>
            </div>
        </div>
